...
function Session(options) {
	...
	if (options.socket) {
		...
		if(this.localPort && this.localAddress){
			this.socket = net.connect({port: this.port, host: this.host, localPort: this.localPort, localAddress: this.localAddress, addressType: this.addressType});
		} else{
...
Session.prototype.connect = function() {
	...
	this._callbacks = [];
	if(this.localPort){
		this.socket.connect({port: this.port, host: this.host, localPort: this.localPort, localAddress: this.localAddress, addressType: this.addressType});//todo test it
	}
	else{
...
exports.connect = exports.createSession = function(host, port, addressType, localAddress, localPort) {
	return new Session({
		host: host || 'localhost',
